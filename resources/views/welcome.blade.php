...
<!-- tabs --> <div class="tab-content">
                        ...
                        <div id="agricultura3" class="tab-pane fade ">
                            ...
                            <div class="space text-center" style="padding-bottom:0px;">
                                <ul class="pagination pagination-sm">
                                  ...
                                  <li class="disabled"><a data-target><i class="glyphicon glyphicon-minus"></i></a></li>
                                  <li><a data-toggle="pill" data-target="#cidadania"><i class="glyphicon glyphicon-chevron-right"></i></a></li>
                        ...
                        <div id="cultura" class="tab-pane fade in ">
                            ...
                            <div class="space text-center" style="padding-bottom:0px;">
                                <ul class="pagination pagination-sm">
                                <li><a data-toggle="pill" data-target="#cidadania6"><i class="glyphicon glyphicon-chevron-left"></i></a></li>
                                  <li class="disabled"><a data-target><i class="glyphicon glyphicon-minus"></i></a></li>
                        ...
                        <div id="cidadania" class="tab-pane fade">
                            ...
                            <div class="space text-center" style="padding-bottom:0px;">
                                <ul class="pagination pagination-sm">
                                <li><a data-toggle="pill" data-target="#agricultura3"><i class="glyphicon glyphicon-chevron-left"></i></a></li>                              
                                  <li class="disabled"><a data-target><i class="glyphicon glyphicon-minus"></i></a></li>
                        ...
                        <div id="cidadania6" class="tab-pane fade">
                            ...
                            <div class="space text-center" style="padding-bottom:0px;">
                                <ul class="pagination pagination-sm">
                                  <li><a data-toggle="pill" data-target="#cidadania5"><i class="glyphicon glyphicon-chevron-left"></i></a></li>
                                  <li class="disabled"><a data-target><i class="glyphicon glyphicon-minus"></i></a></li>
                                <li><a data-toggle="pill" data-target="#cultura"><i class="glyphicon glyphicon-chevron-right"></i></a></li>
                                </ul>
                        ...
                        <div id="habitacao" class="tab-pane fade">
                            ...
                            <div class="space text-center" style="padding-bottom:0px;">
                                <ul class="pagination pagination-sm">
                                 <li ><a data-toggle="pill" data-target="#mobilidade2"><i class="glyphicon glyphicon-chevron-left"></i></a></li>
                                  <li class="disabled"><a data-target><i class="glyphicon glyphicon-minus"></i></a></li>
                            ...
                            <div class="branco col-sm-4">
                                ...
                                <div class="space text-center" style="padding-bottom:0px;">
                                    <ul class="pagination pagination-sm">
                                      ...
                                      <li class="disabled"><a data-target><i class="glyphicon glyphicon-minus"></i></a></li>
                                     <li><a data-toggle="pill" data-target="#habitacao"><i class="glyphicon glyphicon-chevron-right"></i></a></li>
                                    </ul>
                        ...
                        <div id="saude6" class="tab-pane fade">
                            ...
                            <div class="space text-center" style="padding-bottom:0px;">
                                <ul class="pagination pagination-sm">
                                  ...
                                  <li class="disabled"><a data-target><i class="glyphicon glyphicon-minus"></i></a></li>
                                 <li ><a data-toggle="pill" data-target="#agricultura"><i class="glyphicon glyphicon-chevron-right"></i></a></li>
                                </ul>
